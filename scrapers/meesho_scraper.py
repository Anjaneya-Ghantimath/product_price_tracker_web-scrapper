...
class MeeshoScraper(BaseScraper):
    def supports(self, url: str) -> bool:
        return "meesho.com" in url

    async def parse(self, html: str, url: str) -> Dict[str, Any]:
        soup = bs4(html)
        
        # Product title - Meesho specific selectors
        title_el = soup.select_one("h1[data-testid='product-title']") or \
                  ...
                  soup.select_one("[class*='product-name']")
        title = title_el.get_text(strip=True) if title_el else None

        # Current price - Meesho specific selectors
        ...
        # Original price (strikethrough) - Meesho specific selectors
        ...
        # Product image - Meesho specific selectors (Amazon-like approach)
        image_url = None
        
        # Try multiple approaches to find the main product image
        img_selectors = [
            # Primary Meesho selectors
                ...
                for attr in ["src", "data-src", "data-lazy", "data-original"]:
                    ...
                    if temp_url and temp_url.strip():
                        ...
                        if temp_url.startswith("//"):
                            ...
                            temp_url = "https://www.meesho.com" + temp_url
