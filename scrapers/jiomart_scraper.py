...
class JioMartScraper(BaseScraper):
    def supports(self, url: str) -> bool:
        return "jiomart.com" in url

    async def parse(self, html: str, url: str) -> Dict[str, Any]:
        soup = bs4(html)
        
        # Product title - JioMart specific selectors
        ...
        # Current price - JioMart specific selectors
        ...
        # Original price (strikethrough) - JioMart specific selectors
        ...
        # Product image - JioMart specific selectors (Amazon-like approach)
        image_url = None
        
        # Try multiple approaches to find the main product image
        img_selectors = [
            # Primary JioMart selectors
                ...
                for attr in ["src", "data-src", "data-lazy", "data-original"]:
                    ...
                    if temp_url and temp_url.strip():
                        ...
                        if temp_url.startswith("//"):
                            ...
                            temp_url = "https://www.jiomart.com" + temp_url
