...
class NykaaScraper(BaseScraper):
    ...
    async def parse(self, html: str, url: str) -> Dict[str, Any]:
        ...
        # Product title - Nykaa specific selectors
        ...
        # Current price - Nykaa specific selectors
        ...
        # Original price (strikethrough) - Nykaa specific selectors
        ...
        # Product image - Nykaa specific selectors (Amazon-like approach)
        image_url = None
        
        # Try multiple approaches to find the main product image
        img_selectors = [
            # Primary Nykaa selectors
                ...
                for attr in ["src", "data-src", "data-lazy", "data-original"]:
                    ...
                    if temp_url and temp_url.strip():
                        ...
                        if temp_url.startswith("//"):
                            ...
                            temp_url = "https://www.nykaa.com" + temp_url
